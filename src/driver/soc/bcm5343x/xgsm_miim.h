/*
 * $Id: xgsm_miim.h,v 1.2 Broadcom SDK $
 *
...
extern int
cdk_xgsm_sbus_read(int unit, uint32_t phy_addr, uint32_t phy_reg, uint32_t *phy_data);

extern int
cdk_xgsm_sbus_write(int unit, uint32_t phy_addr, uint32_t phy_reg, uint32_t phy_data);
