/*
 *         
 * $Id: qmod_cfg_seq.c,v 1.1 Broadcom SDK $ Broadcom SDK $
 * 
...
int qmod_autoneg_local_ability_get(PHYMOD_ST* pc, qmod_an_ability_t *an_ability_st)
{
 ...
 /* change from PHYMOD_E_FAIL to PHYMOD_E_NONE to enable forced speed with pm_qtc debug */
  return PHYMOD_E_NONE;
}
...
int qmod_get_pcs_link_status(PHYMOD_ST* pc, uint32_t sub_port, uint32_t *link)
{
 ...
 if (PHYMOD_ACC_F_QMODE_GET(pc)) {
    switch (sub_port) {
        case 0:
            *link = BCMI_QTC_XGXS_PCS_LIVE_STSr_LINK_STATUS_SP0f_GET(reg_pcs_live_sts);
            break;
        case 1:
            *link = BCMI_QTC_XGXS_PCS_LIVE_STSr_LINK_STATUS_SP1f_GET(reg_pcs_live_sts);
            break;
        case 2:
            *link = BCMI_QTC_XGXS_PCS_LIVE_STSr_LINK_STATUS_SP2f_GET(reg_pcs_live_sts);
            break;
        default:
            *link = BCMI_QTC_XGXS_PCS_LIVE_STSr_LINK_STATUS_SP3f_GET(reg_pcs_live_sts);
            break;
    }
