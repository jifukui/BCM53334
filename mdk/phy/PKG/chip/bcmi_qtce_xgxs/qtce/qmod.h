 ...
 *----------------------------------------------------------------------*/
/*
 * $Id: qmod.h,v 1.1 Broadcom SDK $ SDK
SDK $Copyright: Copyright 2016 Broadcom Corporation.
SDK This program is the proprietary software of Broadcom Corporation
SDK and/or its licensors, and may only be used, duplicated, modified
SDK or distributed pursuant to the terms and conditions of a separate,
...
extern int qmod_disable_get (PHYMOD_ST *pc, uint32_t* enable);
...
extern int qmod_autoneg_local_ability_get(PHYMOD_ST* pc, qmod_an_ability_t *an_ability_st);
extern int qmod_autoneg_remote_ability_get(PHYMOD_ST* pc, qmod_an_ability_t *an_ability_st);
