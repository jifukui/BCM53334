/*
 * $Id: bcmi_tsc_xgxs_drv.c,v 1.3 Broadcom SDK $
 *
...
#define TSC_CL37_WO_BAM                 0x2
#define TSC_CL73_WO_BAM                 0x2
...
/*
 * Function:
 *      _tsc_addr_type_all_proxy
 * Purpose:
 *      Get the address access type in all proxy mode.
 * Parameters:
 ...
 */
static int
_tsc_addr_type_all_proxy(phy_ctrl_t* pc, uint32_t addr)
{
    int viol = 6;
    ...
    addr &= 0xffff;
    if ((addr & 0xfff0) == 0xffc0 || addr == 0xc138) {
        viol = 0;
    }
 ...
 */
static int
_tsc_plldiv_get(phy_ctrl_t *pc, int *plldiv)
{
    int ioerr = 0;
    SETUPr_t setup;
...
_tsc_credit_set(phy_ctrl_t* pc, int cntl)
{
    int ioerr = 0;
    int rv = CDK_E_NONE;
    int plldiv, actual_speed;
    uint32_t replication_cnt, pcs_clkcnt0, pcs_creditgencnt;
...
_tsc_encode_set(phy_ctrl_t* pc, int cntl)
{
    int ioerr = 0;
    int rv = CDK_E_NONE;
    int actual_speed, plldiv;
    uint32_t encode_mode, cl49_bypass_txsm;
...
_tsc_decode_set(phy_ctrl_t* pc, int cntl)
{
    ...
    int rv = CDK_E_NONE;
    int plldiv, actual_speed;
    uint32_t descramblemode, decodemode, deskewmode, desc2_mode;
    ...
    if (ram_base == 0x0fbe) {
        if ((actual_speed == FV_adr_20G_CR2)||
            ...
            (actual_speed == FV_adr_40G_KR4)||
            (actual_speed == FV_adr_40G_CR4)) {
            CL82_RX_AM_TIMERr_SET(cl82_rx_am_timer, 0x03ff);
...
_tsc_autoneg_control_set(phy_ctrl_t* pc, int an_type, int autoneg)
{
    ...
    ENABLESr_CL37_AN_RESTARTf_SET(enables, 1);
...
_tsc_init_stage_0(phy_ctrl_t *pc)
{
    ...
    /* Reset all rx/tx lanes analog */
    ioerr += READ_RESETr(pc, &reset);
    RESETr_RX_RESET_ANALOGf_SET(reset, 0xf);
    RESETr_TX_RESET_ANALOGf_SET(reset, 0xf);
    ioerr += WRITE_RESETr(pc, reset);
...
_tsc_init_stage_2(phy_ctrl_t *pc)
{
    ...
    /* Add address type call back function at the start of stage 2 */
    rv = PHY_CONFIG_GET(pc, PhyConfig_RamBase,
                        &ram_base, NULL);
    if (ram_base == 0x0fbe) {
        PHY_CTRL_ADDR_TYPE(pc) = _tsc_addr_type_all_proxy;
    } else if (ram_base == 0x0f00) {
...
//    TX_X4_CREDIT0r_CREDITENABLEf_SET(tx_x4_credit0, 0);
    ...
    CL73_BASE_ABIL_0r_BASE_100GBASE_CR10f_SET(cl73_base_abil_0, 0);
    CL73_BASE_ABIL_0r_BASE_40GBASE_CR4f_SET(cl73_base_abil_0, 0);
    CL73_BASE_ABIL_0r_BASE_40GBASE_KR4f_SET(cl73_base_abil_0, 0);
    /* 10G need to set since an=on, the port need to run 10G */
    CL73_BASE_ABIL_0r_BASE_10GBASE_KRf_SET(cl73_base_abil_0, 0);
    CL73_BASE_ABIL_0r_BASE_10GBASE_KX4f_SET(cl73_base_abil_0, 0);
    CL73_BASE_ABIL_0r_BASE_1000BASE_KXf_SET(cl73_base_abil_0, 1);
    CL73_BASE_ABIL_0r_CL73_PAUSEf_SET(cl73_base_abil_0, 1);
    CL73_BASE_ABIL_0r_FECf_SET(cl73_base_abil_0, 0);
    CL73_BASE_ABIL_0r_NEXT_PAGEf_SET(cl73_base_abil_0, 0);
    CL73_BASE_ABIL_0r_CL73_REMOTE_FAULTf_SET(cl73_base_abil_0, 0);
    CL73_BASE_ABIL_0r_RESERVED0f_SET(cl73_base_abil_0, 0);
    ...
    CL73_BAM_ABILr_BAM_20GBASE_KR2f_SET(cl73_bam_abil, 0);
    ioerr += WRITE_CL73_BAM_ABILr(pc, cl73_bam_abil);

    OVER1G_ABIL_0r_CLR(over1g_abil_0);
    OVER1G_ABIL_0r_RESERVED0f_SET(over1g_abil_0, 0);
    OVER1G_ABIL_0r_BAM_12P7GBASE_X2f_SET(over1g_abil_0, 0);
    OVER1G_ABIL_0r_BAM_12P5GBASE_X4f_SET(over1g_abil_0, 0);
    OVER1G_ABIL_0r_BAM_12GBASE_X4f_SET(over1g_abil_0, 0) ;
    OVER1G_ABIL_0r_BAM_10P5GBASE_X2f_SET(over1g_abil_0, 0);
    OVER1G_ABIL_0r_BAM_10GBASE_X2_CX4f_SET(over1g_abil_0, 0);
    OVER1G_ABIL_0r_BAM_10GBASE_X2f_SET(over1g_abil_0, 0);
    OVER1G_ABIL_0r_BAM_10GBASE_X4_CX4f_SET(over1g_abil_0, 0);
    OVER1G_ABIL_0r_BAM_10GBASE_X4f_SET(over1g_abil_0, 0);
    OVER1G_ABIL_0r_BAM_6GBASE_X4f_SET(over1g_abil_0, 0);
    OVER1G_ABIL_0r_BAM_5GBASE_X4f_SET(over1g_abil_0, 0);
    ...
    OVER1G_ABIL_1r_BAM_40GBASE_X4f_SET(over1g_abil_1, 0);
    OVER1G_ABIL_1r_BAM_32P7GBASE_X4f_SET(over1g_abil_1, 0);
    OVER1G_ABIL_1r_BAM_31P5GBASE_X4f_SET(over1g_abil_1, 0);
    OVER1G_ABIL_1r_BAM_25P455GBASE_X4f_SET(over1g_abil_1, 0);
    OVER1G_ABIL_1r_BAM_21GBASE_X4f_SET(over1g_abil_1, 0);
    OVER1G_ABIL_1r_BAM_20GBASE_X2_CX4f_SET(over1g_abil_1, 0);
    OVER1G_ABIL_1r_BAM_20GBASE_X2f_SET(over1g_abil_1, 0);
    OVER1G_ABIL_1r_BAM_20GBASE_X4f_SET(over1g_abil_1, 0);
    OVER1G_ABIL_1r_BAM_20GBASE_X4_CX4f_SET(over1g_abil_1, 0);
    OVER1G_ABIL_1r_BAM_16GBASE_X4f_SET(over1g_abil_1, 0);
    OVER1G_ABIL_1r_BAM_15P75GBASE_X2f_SET(over1g_abil_1, 0);
    OVER1G_ABIL_1r_BAM_15GBASE_X4f_SET(over1g_abil_1, 0);
    OVER1G_ABIL_1r_BAM_13GBASE_X4f_SET(over1g_abil_1, 0);
...
//    TX_X4_CREDIT0r_CREDITENABLEf_SET(tx_x4_credit0, 0);
    ...
    switch(lane_num) {
    case 1:
        RESETr_RX_RESET_ANALOGf_SET(reset, 0xc);
        RESETr_TX_RESET_ANALOGf_SET(reset, 0xc);
        break;
    case 2:
        RESETr_RX_RESET_ANALOGf_SET(reset, 0x8);
        RESETr_TX_RESET_ANALOGf_SET(reset, 0x8);
        break;
    case 3:
        RESETr_RX_RESET_ANALOGf_SET(reset, 0x0);
        RESETr_TX_RESET_ANALOGf_SET(reset, 0x0);
        break;
    /* Lane 0 */
    default:
        RESETr_RX_RESET_ANALOGf_SET(reset, 0xe);
        RESETr_TX_RESET_ANALOGf_SET(reset, 0xe);
    break;
    }
    ioerr += WRITE_RESETr(pc, reset);
    ...
    /* Default mode is fiber if not changed by external PHY */
 ...
 */
static int
_tsc_ability_set(phy_ctrl_t *pc, uint32_t ability)
{
    int ioerr = 0;
    CL73_BASE_ABIL_0r_t cl73_base_abil_0;

    ioerr += READ_CL73_BASE_ABIL_0r(pc, &cl73_base_abil_0);
    if(IS_4LANE_PORT(pc)) {
#if 0 
...
#endif
    } else if(IS_1LANE_PORT(pc)) { /* one-lane port */
...
bcmi_tsc_xgxs_speed_set(phy_ctrl_t *pc, uint32_t speed)
{
    int ioerr = 0;
    int rv = CDK_E_NONE;
    int autoneg, aspeed, plldiv, txdrv;
    int lane_mask, cur_plldiv, fw_mode;
    uint32_t cur_speed, data;
    TX_X4_CREDIT0r_t tx_x4_credit0;
    TX_X4_PCS_CLOCKCNT0r_t tx_x4_pcs_clockcnt0;
    RESETr_t reset;
    DSC_MISC_CTRL0r_t dsc_misc_ctrl0;
...
bcmi_tsc_xgxs_autoneg_set(phy_ctrl_t *pc, int autoneg)
{
    int ioerr = 0;
    int rv = CDK_E_NONE;
    int cl73_an, cl37_an, an_cl72, an_type, plldiv;
    int lane_num, lane_mask, cur_an, txdrv;
    uint32_t spm, ram_base;
    uint32_t data;
    RESETr_t reset;
    SETUPr_t setup;
    IGNORE_LINK_TIMERr_t ignore_link_timer;
    TICK_CONTROL_0r_t tick_ctrl_0;
    TICK_CONTROL_1r_t tick_ctrl_1;
    LINK_UPr_t link_up;
    CL73_BREAK_LINKr_t cl73_break_link;
    CL37_RESTARTr_t cl37_rst;
    CL37_ACKr_t cl37_ack;
    CL73_ERRORr_t cl37_error;
    TX_X4_CREDIT0r_t tx_x4_credit0;
    RX_X4_RX_SIGDETr_t rx_x4_rx_sigdet;
    DSC_MISC_CTRL0r_t dsc_misc_ctrl0;
    RX_X4_DECODE_CONTROL_0r_t rx_x4_dec_ctrl_0;
    ...
    /* Use bit29 of flags for cl37 */
    if (PHY_CTRL_FLAGS(pc) & (1L << 29)) {
        cl37_an = TSC_CL37_WO_BAM;
    } else {
        cl37_an = 0;
    }
    /* Use bit28 of flags for cl73 */
    if (PHY_CTRL_FLAGS(pc) & (1L << 28)) {
        cl73_an = TSC_CL73_WO_BAM;
    } else {
        cl73_an = 0;
    }
    ...
    if (autoneg) {
        ...
        spm = (tsc_mode == FV_pm_1port_3210) ? 1 : 0;

        SETUPr_PORT_MODE_SELf_SET(setup, tsc_mode);
        ...
        if (ram_base == 0x0fbe) {
            IGNORE_LINK_TIMERr_SET(ignore_link_timer, 0xf);
            ioerr += WRITE_IGNORE_LINK_TIMERr(pc, ignore_link_timer);

            ioerr += READ_TICK_CONTROL_0r(pc, &tick_ctrl_0);
            TICK_CONTROL_0r_TICK_NUMERATOR_LOWERf_SET(tick_ctrl_0, 0);
            TICK_CONTROL_0r_TICK_DENOMINATORf_SET(tick_ctrl_0, 1);
            ioerr += WRITE_TICK_CONTROL_0r(pc, tick_ctrl_0);

            ioerr += READ_TICK_CONTROL_1r(pc, &tick_ctrl_1);
            TICK_CONTROL_1r_TICK_OVERRIDEf_SET(tick_ctrl_1, 1);
            if ((an_type == FV_an_CL37) || (an_type == FV_an_CL37_SGMII)||
                (an_type == FV_an_CL37_BAM) || (an_type == FV_an_CL37_10G)) {
                TICK_CONTROL_1r_TICK_NUMERATOR_UPPERf_SET(tick_ctrl_1, 1);
            } else {
                TICK_CONTROL_1r_TICK_NUMERATOR_UPPERf_SET(tick_ctrl_1, 8);
            }
            ioerr += WRITE_TICK_CONTROL_1r(pc, tick_ctrl_1);

            ioerr += READ_LINK_UPr(pc, &link_up);
            LINK_UPr_CL73_LINK_UP_TIMER_PERIODf_SET(link_up, 0);
            ioerr += WRITE_LINK_UPr(pc, link_up);

            ioerr += READ_CL73_BREAK_LINKr(pc, &cl73_break_link);
            CL73_BREAK_LINKr_TX_DISABLE_TIMER_PERIODf_SET(cl73_break_link, 0x5);
            ioerr += WRITE_CL73_BREAK_LINKr(pc, cl73_break_link);

            ioerr += READ_CL37_RESTARTr(pc, &cl37_rst);
            CL37_RESTARTr_CL37_RESTART_TIMER_PERIODf_SET(cl37_rst, 0x1f);
            ioerr += WRITE_CL37_RESTARTr(pc, cl37_rst);

            ioerr += READ_CL37_ACKr(pc, &cl37_ack);
            CL37_ACKr_CL37_ACK_TIMER_PERIODf_SET(cl37_ack, 0x1f);
            ioerr += WRITE_CL37_ACKr(pc, cl37_ack);

            ioerr += READ_CL73_ERRORr(pc, &cl37_error);
            CL73_ERRORr_CL73_ERROR_TIMER_PERIODf_SET(cl37_error, 0x64);
            ioerr += WRITE_CL73_ERRORr(pc, cl37_error);

            ioerr += READ_LINK_FAIL_INHIBIT_TIMER_NOT_CL72r(pc, &link_fail_inhibit_timer_not_cl72);
            LINK_FAIL_INHIBIT_TIMER_NOT_CL72r_LINK_FAIL_INHIBIT_TIMER_NCL72_PERIODf_SET(link_fail_inhibit_timer_not_cl72, 64);
            ioerr += WRITE_LINK_FAIL_INHIBIT_TIMER_NOT_CL72r(pc, link_fail_inhibit_timer_not_cl72);
        }
        ...
        TX_X2_MLD_SWAP_COUNTr_SET(tx_x2_mld_swap_count, data);
        ioerr += WRITE_TX_X2_MLD_SWAP_COUNTr(pc, tx_x2_mld_swap_count);
        ...
        CL82_RX_AM_TIMERr_SET(cl82_rx_am_timer, data);
        ioerr += WRITE_CL82_RX_AM_TIMERr(pc, cl82_rx_am_timer);
...
bcmi_tsc_xgxs_config_set(phy_ctrl_t *pc, phy_config_t cfg, uint32_t val, void *cd)
{
    ...
    case PhyConfig_RamBase: {
        ...
        CONFIG_CONTROLr_RAM_BASEf_SET(cfg_ctrl, val);
    ...
    case PhyConfig_XauiTxLaneRemap: {
        ...
        if (odd_chip) {
            for(i = 0; i < 4; i++) {
                lswap_tx |= ((val>>(bwpl*(3-i))) & LANE_NUM_MASK) << (bwpl*i);
            }
        } else {
            lswap_tx = val;
        }
    ...
    case PhyConfig_AdvLocal: {
        return _tsc_ability_set(pc, val);
    }
    default:
        break;
    }
