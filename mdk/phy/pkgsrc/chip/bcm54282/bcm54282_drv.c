/*
 * $Id: bcm54282_drv.c,v 1.6 Broadcom SDK $
 *
...
#define EEE_RSL_STATUSr                       0x07803e0e
...
/*
 * Function:
 *      _bcm54282_abiliby_eee_remote_get
 * Purpose:
 *      Get remote phy eee ability.
 * Parameters:
 *      pc - PHY control structure
 *      ability - ability value
 * Returns:
    ...
    if (CDK_SUCCESS(rv)) {
        if (PHY_CTRL_FLAGS(pc) & PHY_F_FIBER_MODE) {
            ...
            case 100:
                ...
                SERDES_100FX_CTRLr_FX_SERDES_ENf_SET(fx100_ctrl, 1);
                break;
            case 1000:
                MII_1000X_CTRLr_SS_MSBf_SET(mii_1000x_ctrl, 1);
                MII_1000X_CTRLr_SS_LSBf_SET(mii_1000x_ctrl, 0);
                SERDES_100FX_CTRLr_FX_SERDES_ENf_SET(fx100_ctrl, 0);
                break;
            default:
                return CDK_E_CONFIG;
            }
...
bcm54282_phy_config_set(phy_ctrl_t *pc, phy_config_t cfg, uint32_t val, void *cd)
{
    ...
    case PhyConfig_EEE:
    {
        ...
        if (val == PHY_EEE_802_3) {
            ...
            /* Enable LPI feature */
            ioerr += READ_EEE_803Dr(pc, &eee_803d);
            EEE_803Dr_LPI_FEATURE_ENABLEf_SET(eee_803d, 1);
            EEE_803Dr_EEE_CAPABILITY_USING_QSGMII_ANf_SET(eee_803d, 1);
            ioerr += WRITE_EEE_803Dr(pc, eee_803d);

            /* advertise EEE capability */
            ioerr += READ_EEE_ADVr(pc, &eee_adv);
            EEE_ADVr_EEE_1000BASE_Tf_SET(eee_adv, 1);
            EEE_ADVr_EEE_100BASE_TXf_SET(eee_adv, 1);
            ioerr += WRITE_EEE_ADVr(pc, eee_adv);
...
bcm54282_phy_config_get(phy_ctrl_t *pc, phy_config_t cfg, uint32_t *val, void *cd)
{
    ...
    case PhyConfig_EEE:
    {
        int ioerr = 0;
        ioerr += READ_EEE_803Dr(pc, &eee_803d);
        if (EEE_803Dr_LPI_FEATURE_ENABLEf_GET(eee_803d) && EEE_803Dr_EEE_CAPABILITY_USING_QSGMII_ANf_GET(eee_803d))
        {
            *val = PHY_EEE_802_3;
        } else {
            *val = PHY_EEE_NONE;
    ...
    case PhyConfig_AdvRemote: {
        ...
        ioerr = _bcm54282_abiliby_remote_get(pc, val);
        return ioerr;
    }
    case PhyConfig_AdvEEERemote:
    {
        ...
        ioerr = _bcm54282_ability_eee_remote_get(pc, val);
        return ioerr;
    }
    default:
        break;
...
phy_driver_t bcm54282_drv = {
    "bcm5428(9)2",
    "BCM5428(9)2 Gigabit PHY Driver",
    0,
