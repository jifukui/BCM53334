;
; $Id: hr2_embedded_16x1g_2.asm,v 1.3.6.1 Broadcom SDK $
;
...
; 
;
; This is the default program for the (24 port) BCM953334K
; reference board.
;
...
;       ONE,  ZERO, ZERO, ZERO      Green on both left
;
...
;       Green on right: link up
;       Alternating green on left: both RX and TX
