/*
 * $Id: board.h,v 1.24 Broadcom SDK $
 *
...
#define  BOARD_MAX_NUM_OF_PORTS         (32)
...
#define BOARD_CCA_UART_CLOCK           (91898)
...
#define BOARD_CCA_UART_CLOCK       (100000000)

/* CPU clock in Hz (125MHz) */
#define BOARD_CPU_CLOCK            (125000000)
#endif
...
#define BOARD_FIRMWARE_ADDR            (0x1C060000)

/* Shared internal SRAM memory address for loader and firmware */
#define BOARD_BOOKKEEPING_ADDR         (0x1B000000)

/* Used for packet DMA */
#define CFG_DMA_HEAP_START             (0x1B002000)

#define CFG_DMA_HEAP_SIZE              (0x2000)

/* Frimware address to program */
#define BOARD_SECONDARY_FIRMWARE_ADDR  (0x1C130000)

/* Config address */
#define CFG_CONFIG_BASE                 (0x1C05D000)
#define CFG_CONFIG_OFFSET               (0x000)
#define CFG_CONFIG_SIZE                 (0x1000 - CFG_CONFIG_OFFSET)

/* Factory config address */
#define CFG_FACTORY_CONFIG_BASE        (0x1C05E000)
#define CFG_FACTORY_CONFIG_OFFSET      (0x0)

/* Persistence address */
#define CFG_FLASH_START_ADDRESS        (0x1C000000)

#define MEDIUM_FLASH_START_ADDRESS     (0x1C05F000)

#define MEDIUM_FLASH_SIZE              (0x1000)

/* Shortcut TX/RX for boot loader */
#define BOOT_SOC_INCLUDE_FILE          "soc/bcm5333x.h"
#define BOOT_FUNC_TX                    bcm5333x_tx
#define BOOT_FUNC_RX_SET_HANDLER        bcm5333x_rx_set_handler
#define BOOT_FUNC_RX_FILL_BUFFER        bcm5333x_rx_fill_buffer
