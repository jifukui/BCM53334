...
include ${TOP}/systems/bcm95333x/um_version.mk
...
LDLIBS = -lphyecd  -lphypkgsrc -lphyutil -lphygeneric
#
...
BSP_SRC    = ${BUILD_DIR}/src
BSP_INC    = ${BUILD_DIR}/include
LIB_PATH   = ${BUILD_DIR}/lib
MAIN_SRC   = ${TOP}/src/kernel
MAIN_INC   = ${TOP}/include
SOC_SRC    = ${TOP}/src/driver/soc/bcm5333x
UIP_SRC    = ${TOP}/src/net
...
CFE_INC = ${TOP}/include ${TOP}/include/arm ${TOP}/src/net ${TOP}/src/appl/web/content ${XCMD_INC}
...
APPLOBJS = app_init.o dhcpc.o igmpsnoop.o igmpsnoop_cbk.o mdns.o mdns_utils.o snaketest.o
...
SWITCHOBJ = hr2switch.o hr2rxtx.o hr2vlan.o hr2port.o\
            hr2loop.o hr2mdns.o  unimac.o xlmac.o
SWITCHOBJ += mdk_phy.o cdk_debug.o bcm56150_miim_int.o bcm956150k_miim_ext.o
SRCDIRS += ${TOP}/src/driver/flash
SRCDIRS += ${TOP}/src/driver/soc/bcm5333x

UTILSOBJS = ui_utils.o net_utils.o ports_utils.o ui_utils.o factory_utils.o pbmp.o nvram_utils.o system_utils.o
...
%.o : %.S
	@echo ""
	$(GCCAS) -D_LANGUAGE_ASSEMBLY -D__ASSEMBLER__ $(CFE_CFLAGS) $(CFLAGS) -include $(BUILD_DIR)/conf.h -MP -MD -o $@ $< -c
