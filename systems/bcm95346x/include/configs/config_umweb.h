/*
 * $Id: config_umweb.h,v 1.7 Broadcom SDK $
 *
...
#define CONFIG_METROLITE_ROMCODE           (0)

#define CONFIG_METROLITE_EMULATION         (0)
...
#define CFG_UIP_STACK_ENABLED               (1)
...
/* End with dot symbol */
#define CFG_MDNS_DEFAULT_HTTP_INSTANCE "UM-BCM95346x."
/* TXT record information */
#define CFG_MDNS_MODEL_NAME "BCM95346xR"
#define CFG_MDNS_MODEL_DESC "BCM95346x Reference Board"
...
/*
  *  CFG_TSCE_INTERFACE : SERDES_INTERFACE_SGMII/SERDES_INTERFACE_FIBER
  */
#define CFG_TSCE_INTERFACE   (SERDES_INTERFACE_FIBER)

/*
  *  CFG_VIPER_INTERFACE : SERDES_INTERFACE_SGMII/SERDES_INTERFACE_FIBER
  */
#define CFG_VIPER_INTERFACE   (SERDES_INTERFACE_FIBER)
#endif /* _CONFIG_H_ */
