...
include ${TOP}/systems/bcm95340x/um_version.mk
...
SOC_SRC    = ${TOP}/src/driver/soc/bcm5340x
UIP_SRC    = ${TOP}/src/net
...
SWITCHOBJ = ghswitch.o ghrxtx.o ghvlan.o ghport.o ghloop.o \
            ghmdns.o unimac.o xlmac.o 

SWITCHOBJ += mdk_phy.o cdk_debug.o bcm5340x_miim_int.o bcm95340xk_miim_ext.o

ifeq ($(strip ${CFG_SOC_SNAKE_TEST}), 1)
SWITCHOBJ += ghsnaketest.o
endif

SRCDIRS += ${TOP}/src/driver/flash
SRCDIRS += ${TOP}/src/driver/soc/bcm5340x 
...
ifndef BCM_PHY_LIST
BCM_PHY_LIST=84848 54210 54280 54282 QSGMII TSCE
endif
