...
include ${TOP}/systems/bcm95343x/um_version.mk
...
SOC_SRC    = ${TOP}/src/driver/soc/bcm5343x
UIP_SRC    = ${TOP}/src/net
...
SWITCHOBJ = hr3switch.o hr3rxtx.o hr3vlan.o hr3port.o hr3loop.o \
            hr3mdns.o unimac.o

SWITCHOBJ += mdk_phy.o cdk_debug.o bcm5343x_miim_int.o bcm95343xk_miim_ext.o
ifeq ($(strip ${CFG_SOC_SNAKE_TEST}), 1)
SWITCHOBJ += hr3snaketest.o
endif
ifeq ($(strip ${CFG_QT}), 1)
SWITCHOBJ += hr3qt.o
endif
...
SRCDIRS += ${TOP}/src/driver/soc/bcm5343x 
