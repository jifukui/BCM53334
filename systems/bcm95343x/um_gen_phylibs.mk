# $Id: um_gen_phylibs.mk,v 1.8 Broadcom SDK $
...
MDK_CFLAGS =  $(filter-out -D%,$(filter-out -I%,$(filter-out -Werror,$(CFLAGS)))) $(MDKSYM_INCLUDE) -DCDK_CONFIG_INCLUDE_BCM56160_A0=1 -DPHY_SYS_USLEEP=sal_usleep  -DBMD_CONFIG_INCLUDE_DMA=0 -DPHY_SYS_USLEEP=sal_usleep -DBMD_SYS_USLEEP=sal_usleep -DPHY_CONFIG_INCLUDE_CHIP_SYMBOLS=$(CFG_MDKSYM) -DCDK_CONFIG_INCLUDE_FIELD_INFO=$(CFG_MDKSYM) -DPHY_DEBUG_ENABLE -DBMD_SYS_DMA_ALLOC_COHERENT=sal_dma_malloc -DBMD_SYS_DMA_FREE_COHERENT=sal_dma_free

export TOOLCHAIN_BIN_DIR LD_LIBRARY_PATH
export PHY_PKG_OPTIONS = -c bcmi_tsce_xgxs,bcm54282,bcmi_qtce_xgxs,bcm56160 -b ,
