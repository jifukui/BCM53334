/*
 * $Id: bmd_phy_ctrl.h,v 1.5 Broadcom SDK $
 *
...
#define BMD_CONFIG_MAX_PORTS   (BOARD_MAX_NUM_OF_PORTS + 1 + 2)
...
#define EXT_PHY_DRV(_u, _p) BMD_PHY_PORT_INFO(_u,_p).phy_ctrl->drv
