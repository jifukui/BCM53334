 ...
 * large...
 */
#define	_SHR_PBMP_PORT_MAX	SOC_MAX_NUM_PORTS
#define	_SHR_PBMP_WIDTH		(((SOC_MAX_NUM_PORTS + 32 - 1)/32)*32)

#if (_SHR_PBMP_WIDTH <= 32) 	/* old style */
...
#define	_SHR_PBMP_ENTRY(bm, port)	     (bm)
...
#define BCM_PBMP_ENTRY(pbm_a, port)  _SHR_PBMP_ENTRY(pbm_a, port)
...
#define PVLAN_BMP_CLEAR(pbm)     _SHR_PBMP_CLEAR(pbm) 
#define PVLAN_BMP_MEMBER(bmp, vlan_id)  _SHR_PBMP_MEMBER((bmp), (vlan_id - 1)) 
#define PVLAN_BMP_COUNT(pbm, count)  _SHR_PBMP_COUNT(pbm, count) 

#define PVLAN_BMP_IS_NULL(pbm)   _SHR_PBMP_IS_NULL(pbm) 
#define PVLAN_BMP_NOT_NULL(pbm)  _SHR_PBMP_NOT_NULL(pbm) 
#define PVLAN_BMP_EQ(pbm_a, pbm_b)  _SHR_PBMP_EQ(pbm_a, pbm_b) 
#define PVLAN_BMP_NEQ(pbm_a, pbm_b)  _SHR_PBMP_NEQ(pbm_a, pbm_b) 

/* Assignment operators */
#define PVLAN_BMP_ASSIGN(dst, src)  _SHR_PBMP_ASSIGN(dst, src) 
#define PVLAN_BMP_AND(pbm_a, pbm_b)  _SHR_PBMP_AND(pbm_a, pbm_b) 
#define PVLAN_BMP_OR(pbm_a, pbm_b)  _SHR_PBMP_OR(pbm_a, pbm_b) 
#define PVLAN_BMP_XOR(pbm_a, pbm_b)  _SHR_PBMP_XOR(pbm_a, pbm_b) 
#define PVLAN_BMP_REMOVE(pbm_a, pbm_b)  _SHR_PBMP_REMOVE(pbm_a, pbm_b) 
#define PVLAN_BMP_NEGATE(pbm_a, pbm_b)  _SHR_PBMP_NEGATE(pbm_a, pbm_b) 

/* PVLAN BMP operators */
#define PVLAN_BMP_VLAN_SET(pbm, vlan_id)  _SHR_PBMP_PORT_SET(pbm, (vlan_id - 1)) 
#define PVLAN_BMP_VLAN_ADD(pbm, vlan_id)  _SHR_PBMP_PORT_ADD(pbm, (vlan_id - 1)) 
#define PVLAN_BMP_VLAN_REMOVE(pbm, vlan_id)  _SHR_PBMP_PORT_REMOVE(pbm, (vlan_id - 1)) 
#define PVLAN_BMP_VLAN_FLIP(pbm, vlan_id)  _SHR_PBMP_PORT_FLIP(pbm, (vlan_id - 1)) 

/* Set the default tag protocol ID (TPID) for the specified port. */
typedef int bcm_port_t;

typedef _shr_pbmp_t pbmp_t;
typedef _shr_pbmp_t pvlan_bmp_t;;
